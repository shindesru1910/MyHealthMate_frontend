    ...
    <>
      <div>
        <nav className={styles.navbarCustom}>
          <div className="container-fluid">
            <span className={styles.welcomeText}>Welcome back, {userFirstName}</span>
          </div>
          <ul className="navbar-nav ms-auto">
            <li>
        ...
        <div className="modal-dialog">
          <div className={styles.modalContent}>
            ...
            <div className={styles.modalBody}>
              <form>
                <div className="mb-3">
                  <label htmlFor="feedbackText" className={styles.formLabel}>Feedback</label>
                  <textarea className={styles.formControl} id="feedbackText" rows="3" value={feedbackText} onChange={handleFeedbackChange}></textarea>
                </div>
              </form>
            </div>
            <div className="modal-footer">
